...
INSERT INTO `ciclo` (`nro_puesto`, `nro_ciclo`, `codigo_prog`, `fecha_hora_inicio`, `fecha_hora_final`,
                    `distancia_inicio`, `distancia_final`, `operario`, `turno`, `utilizar_en_estad`,
                    `campos_extra`, `nro_lote`) VALUES
